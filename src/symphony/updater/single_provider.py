...
async def update_single_provider_impl(updater: "CLIUpdater", provider: InstrumentName) -> CLIVersionStatus:
    ...
    # Manual update: always attempt even if musicians are busy.
    # update_cli() falls back to subprocess when no idle musician is available.
