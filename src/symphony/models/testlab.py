...
class TestVerifyItem(BaseModel):
    ...
    provider: InstrumentName = Field(description="Instrument that was tested.")
...
class TestGenerateRequest(BaseModel):
    ...
    provider: InstrumentName | None = Field(
        default=None,
        description="Override the instrument to use for generation. When absent the cheapest available model is chosen.",
    )
